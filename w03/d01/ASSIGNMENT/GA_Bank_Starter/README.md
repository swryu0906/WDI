...
We 're going to build an application to keep track of the checking and savings balances.
...
###Tips
* Tackle making your accounts work individually first as a command line app
