...
- Should accept 2 arguments. The first one should be a string which will be the name of the Line. The second argument should be an array of stations which will be the line's stations.
